...
final class MixPaintColorActionTest extends WebTestCase
{
    ...
    {
        $file = \json_decode(\file_get_contents(__DIR__ . '/Resources/paints.json'), true, 512, JSON_THROW_ON_ERROR);
    ...
    {
        $file = \json_decode(\file_get_contents(__DIR__ . '/Resources/ratios.json'), true, 512, JSON_THROW_ON_ERROR);
